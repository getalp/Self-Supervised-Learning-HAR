...
clientIndexes =  np.asarray(list(clientIndexes.items()),dtype=object)[:,1]
...
for clientLabel in finalLabel:
    alignedClientLabel = np.asarray([7 if labelInstance == 2 else labelInstance for labelInstance in clientLabel],dtype=object)
