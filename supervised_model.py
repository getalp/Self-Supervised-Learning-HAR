...
class liteFormer(layers.Layer):
    def __init__(self, patchCount,startIndex,stopIndex, projectionSize, kernelSize = 16, attentionHead = 3, use_bias=False, dropPathRate = 0.0,dropout_rate = 0,**kwargs):
        ...
        self.formattedShape = projectionSize * patchCount
    ...
    def call(self, inputs,training=None):
        ...
        localAttention = tf.reshape(convOutputs,(-1,self.patchCount,self.projectionSize))
